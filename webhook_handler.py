    ...
    try:
        ...
        if order_type == 'domain':
            ...
            if results:
                ...
                logger.info(f"💰 OVERPAYMENT: Found domain order - expected: ${expected_amount}, received: ${received_amount} (adjusted: ${received_for_overpayment} after padding)")
...
async def _process_rdp_payment(order_id: str, payment_details: Dict[str, Any]):
    ...
    try:
        ...
        minimum_acceptable = total_amount * Decimal('0.97')  # 3% tolerance
